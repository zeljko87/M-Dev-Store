...
<form action="" method="post" enctype="multipart/form-data">
    ...
    <div class="form-group">
        ...
        <input type="email" name="c_email" class="form-control" value="<?php echo $customer_email; ?>">
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        ...
        <img class="img-responsive" src="customer_images/<?php echo $customer_img; ?>" alt="Customer Image">
    </div>
...
<?php
    if(isset($_POST['update']))
    {
        ...
        move_uploaded_file($temp_image, "customer_images/$c_image");
        $update_customer = "update customers set customer_name='$c_name', customer_email='$c_email'";
        $update_customer .= ", customer_country='$c_country', customer_city='$c_city', customer_contact='$c_contact'";
        $update_customer .= ", customer_address='$c_address', customer_image='$c_image' where customer_id='$update_id'";
